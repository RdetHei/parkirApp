    ...
    <div class="max-w-5xl mx-auto relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 lg:mb-12">
            <div>
                ...
                <h1 class="text-3xl lg:text-4xl font-black tracking-tight text-white uppercase">Tagihan <span class="text-emerald-500">Parkir</span></h1>
                <p class="text-slate-400 text-xs lg:text-sm mt-2 font-medium tracking-wide">Selesaikan pembayaran untuk transaksi parkir yang telah selesai.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 lg:mb-10">
            <div class="card-pro group overflow-hidden relative border-white/5 backdrop-blur-xl bg-slate-900/40 p-6 lg:p-8">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        <p class="text-[9px] lg:text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Tagihan Aktif</p>
                        <p class="text-3xl lg:text-4xl font-black text-white tracking-tighter">{{ $transaksis->total() }} <span class="text-xs lg:text-sm font-bold text-slate-600 tracking-normal ml-1">Transaksi</span></p>
                    </div>
                    <div class="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400">
                        <i class="fa-solid fa-file-invoice-dollar text-xl lg:text-2xl"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="card-pro group overflow-hidden relative border-emerald-500/10 backdrop-blur-xl bg-slate-900/40 p-6 lg:p-8">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        <p class="text-[9px] lg:text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Total Tunggakan</p>
                        <p class="text-3xl lg:text-4xl font-black text-emerald-500 tracking-tighter">Rp {{ number_format($totalTagihan, 0, ',', '.') }}</p>
                    </div>
                    <div class="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500">
