...
@section('content')
    @component('components.form-card', [
        ...
        <div>
            ...
            @if($item->foto_url)
                <div class="mb-4">
                    <img src="{{ $item->foto_url }}" alt="Foto Kendaraan" class="w-48 h-auto rounded-xl shadow-md border border-gray-200">
            ...
            <p class="mt-1 text-xs text-gray-500 italic">Biarkan kosong jika tidak ingin mengubah foto. Format: JPG, PNG, JPEG. Maks: 2MB</p>
