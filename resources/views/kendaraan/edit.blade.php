...
<div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
    ...
    <form action="{{ route('kendaraan.update', $item) }}" method="POST" class="space-y-4">
        ...
        <div class="flex justify-end space-x-2">
            ...
            <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-500">
                Update
            </button>
        </div>
    </form>
