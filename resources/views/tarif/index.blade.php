...
<div class="py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Tarif Parkir</h1>
            <p class="text-sm text-gray-500">Kelola tarif parkir per jenis kendaraan</p>
        </div>
        <a href="{{ route('tarif.create') }}" class="inline-flex items-center px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-colors">
