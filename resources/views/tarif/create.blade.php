...
@section('content')
    @component('components.form-card', [
        ...
        'title' => 'Buat Tarif Baru',
        'description' => 'Tambahkan data tarif parkir baru ke sistem',
        'cardIcon' => '<svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>',
        'cardTitle' => 'Form Tarif',
        'cardDescription' => 'Lengkapi detail tarif',
        ...
        <div class="space-y-8">
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <input type="text" name="jenis_kendaraan" id="jenis_kendaraan" value="{{ old('jenis_kendaraan') }}" required placeholder="Motor / Mobil / Bus / dll"
                ...
                <p class="mt-2 text-[9px] text-slate-600 italic font-bold uppercase tracking-widest ml-1">Masukkan jenis kendaraan secara manual untuk membuat tarif baru.</p>
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <input type="number" name="tarif_perjam" id="tarif_perjam" value="{{ old('tarif_perjam') }}" required min="0" placeholder="0"
