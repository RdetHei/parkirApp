...
@section('content')
    @component('components.form-card', [
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500 italic">Masukkan jenis kendaraan secara manual untuk membuat tarif baru.</p>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="number" name="tarif_perjam" id="tarif_perjam" value="{{ old('tarif_perjam') }}" required min="0" placeholder="Tarif per jam"
