    ...
    <nav class="fixed w-full top-0 z-50 bg-[#020617]/70 backdrop-blur-xl border-b border-white/5" x-data="{ mobileMenuOpen: false }">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ url('/#about') }}" class="text-xs font-semibold text-slate-400 hover:text-white transition-colors">{{ __('About') }}</a>
                    <a href="{{ url('/#workflow') }}" class="text-xs font-semibold text-slate-400 hover:text-white transition-colors">{{ __('Workflow') }}</a>
                    <a href="{{ url('/#fitur') }}" class="text-xs font-semibold text-slate-400 hover:text-white transition-colors">{{ __('Features') }}</a>
                    <a href="{{ route('docs') }}" class="text-xs font-semibold text-slate-400 hover:text-white transition-colors">{{ __('Docs') }}</a>
                    <a href="{{ url('/#contact') }}" class="text-xs font-semibold text-slate-400 hover:text-white transition-colors">{{ __('Contact') }}</a>
        ...
        <div x-show="mobileMenuOpen"
             ...
             <a href="{{ url('/#about') }}" @click="mobileMenuOpen = false" class="block text-sm font-semibold text-slate-400 hover:text-white transition-colors">About</a>
            <a href="{{ url('/#workflow') }}" @click="mobileMenuOpen = false" class="block text-sm font-semibold text-slate-400 hover:text-white transition-colors">Workflow</a>
            <a href="{{ url('/#fitur') }}" @click="mobileMenuOpen = false" class="block text-sm font-semibold text-slate-400 hover:text-white transition-colors">Features</a>
            <a href="{{ route('docs') }}" class="block text-sm font-semibold text-slate-400 hover:text-white transition-colors">Docs</a>
            <a href="{{ url('/#contact') }}" @click="mobileMenuOpen = false" class="block text-sm font-semibold text-slate-400 hover:text-white transition-colors">Contact</a>
