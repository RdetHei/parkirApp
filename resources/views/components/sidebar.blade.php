        <!-- Sidebar -->
        <aside id="app-sidebar" class="w-64 h-screen sticky top-0 bg-gradient-to-b from-gray-50 to-white border-r border-gray-200 flex-shrink-0 hidden lg:flex flex-col z-50 shadow-sm transition-all duration-200">
            <div class="sidebar-header h-16 border-b border-gray-200 flex items-center justify-between px-3 lg:px-4 bg-white">
                ...
                <button id="sidebar-toggle" type="button"
                        class="hidden lg:inline-flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 text-gray-600 shrink-0"
            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto sidebar-nav">
                ...
                <a href="{{ route('dashboard') }}"
                   class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-green-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('transaksi.index') }}"
                   class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('transaksi.index') ? 'bg-orange-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="pt-4 mt-4 border-t border-gray-200">
                    ...
                    <a href="{{ route('users.index') }}"
                       class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('users.index', 'users.create', 'users.edit', 'users.show') ? 'bg-cyan-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('tarif.index') }}"
                       class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('tarif.index', 'tarif.create', 'tarif.edit', 'tarif.show') ? 'bg-yellow-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    ...
                    <a href="{{ route('area-parkir.index') }}"
                       class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('area-parkir.index', 'area-parkir.create', 'area-parkir.edit', 'area-parkir.show') ? 'bg-red-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('kendaraan.index') }}"
                       class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('kendaraan.index', 'kendaraan.create', 'kendaraan.edit', 'kendaraan.show') ? 'bg-amber-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('log-aktivitas.index') }}"
                       class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all duration-200 {{ request()->routeIs('log-aktivitas.index') ? 'bg-slate-500 text-white shadow-md' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative p-4 border-t border-gray-200 bg-white sidebar-account-wrap">
                ...
                <!-- Popup card -->
                <div id="sidebar-account-popup" class="hidden absolute bottom-full left-4 right-4 mb-2 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">
