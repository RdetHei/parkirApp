    ...
    @component('components.form-card', [
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="nama_area" id="nama_area" value="{{ old('nama_area') }}" required placeholder="Nama area parkir"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}" required min="1" placeholder="Jumlah slot"
