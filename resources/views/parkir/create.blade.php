...
@section('content')
    @component('components.form-card', [
        ...
        'description' => 'Tambahkan kendaraan yang masuk parkir',
        ...
        <div>
            <label for="id_kendaraan" class="block text-sm font-semibold text-gray-700 mb-2">Kendaraan <span class="text-red-500">*</span></label>
            <div class="relative">
