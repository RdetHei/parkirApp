...
@section('content')
    @component('components.form-card', [
        ...
        'title' => 'Tambah Kamera (IP Webcam)',
        'description' => 'Tambahkan kamera untuk scan plat nomor di Catat Masuk',
        ...
        'cardTitle' => 'Form Kamera',
        'cardDescription' => 'URL stream dari app IP Webcam (HP)',
        'action' => route('kamera.store'),
        'method' => 'POST',
        'submitText' => 'Simpan'
    ])
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required placeholder="Contoh: IP Webcam HP Depan"
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">Scanner: untuk scan plat di Catat Masuk. Viewer: untuk tampil di map interaktif.</p>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="url" name="url" id="url" value="{{ old('url', 'http://localhost:8080/video') }}" required placeholder="http://localhost:8080/video atau http://IP_HP:8080/video"
            ...
            <p class="mt-1 text-xs text-gray-500">Dari app IP Webcam di HP: buka browser ke URL yang ditampilkan app, lalu salin path /video (mis. http://192.168.1.5:8080/video)</p>
        ...
        <div>
            <label class="flex items-center gap-2 cursor-pointer">
                ...
                <span class="text-sm font-semibold text-gray-700">Jadikan kamera default (dipakai pertama di Catat Masuk)</span>
            </label>
