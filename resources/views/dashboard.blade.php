                    ...
                    <tbody class="divide-y divide-white/5">
                        @forelse($aktivitasTerbaru as $trx)
                            <tr class="hover:bg-white/[0.02] transition-all group">
                                ...
                                <td class="px-8 py-6">
                                    <p class="text-xs font-black text-white">{{ $trx->waktu_masuk ? $trx->waktu_masuk->diffForHumans() : '-' }}</p>
                                    <p class="text-[10px] text-slate-500 font-bold uppercase">{{ $trx->waktu_masuk ? $trx->waktu_masuk->format('H:i:s') : '-' }}</p>
                                </td>
